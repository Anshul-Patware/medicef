...
class CallibrationDetailsController extends Controller
{
    public function index()
    {
       ...
       return view('frontend.Callibration-Details.Callibration_Details_Create', compact('record_number',) );
    ...
    {      
        ...
        return view('frontend.Callibration-Details.Callibration_Details_View', compact('data', 'calibration', 'record_number',));
    }
