...
class PreventiveMaintenanceController extends Controller
{
    public function index()
    {
       ...
       return view('frontend.preventive-maintenance.preventive_maintenance', compact('record_number',) );
...
{      
    ...
    $due_date = $formattedDate->format('Y-m-d');
    // dd($equipment);
    return view('frontend.preventive-maintenance.preventive_maintenance_View', compact('data', 'equipment', 'record_number',));
}
