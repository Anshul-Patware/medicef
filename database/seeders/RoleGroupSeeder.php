...
class RoleGroupSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $processes_roles = [
            ...
            "Equipment Lifecycle Management" => ['Initiator', 'Supervisor', 'Qualification', 'Training Coordinator', 'QA', 'View Only', 'FP', 'Closed Record'],
            ...
            'Recall_Process' => ['Initiator', 'HOD/Designee', 'CQA Reviewer', 'QA Approver', 'CQA Approver', 'QA', 'CQA Head', 'Head QA', 'QA Head/Designee', 'View Only', 'FP', 'Closed Record'],  
        ];
