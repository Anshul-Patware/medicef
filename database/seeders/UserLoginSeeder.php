...
class UserLoginSeeder extends Seeder
{
    ...
    public function run()
    {
        $rolegroup = DB::table('role_groups')->count();
        ...
        $users = [
            ...
            [
                'name' => 'Himanshu Patil',
                'email' => 'himanshupatil56990@gmail.com',
                'password' => '$2y$10$ybcHMuQ8soPzXcdljEQ/wOUx0JximT3yb5naubluqz3TjOz/tGBlC',
                'departmentid' => 1,
                'username' => "himanshu123",
                'mobile_number' => "9009425693",
                'roles' => range(1, $rolegroup),
            ],
            // [
            //     'name' => 'Gautam Solanki',
            //     'email' => 'gautam@vidyagxp.com',
            //     'password' => '$2y$10$ybcHMuQ8soPzXcdljEQ/wOUx0JximT3yb5naubluqz3TjOz/tGBlC',
            //     'departmentid' => 1,
            //     'username' => "gautam123",
            //     'mobile_number' => "6264992922",
            //     'roles' => range(1, $rolegroup),
            // ],
            // [
            //     'name' => 'Amit Guru',
