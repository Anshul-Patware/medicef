...
class QMSRolesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $roles = [
            ...
            ['id' => 68, 'name' => 'Drafter', 'description' => 'Drafter', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 69, 'name' => 'Purchase Department', 'description' => 'Purchase Department', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 70, 'name' => 'F&D/MS&T', 'description' => 'F&D/MS&T', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 71, 'name' => 'Supplier Auditor', 'description' => 'Supplier Auditor', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 72, 'name' => 'Auditee', 'description' => 'Auditee', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 73, 'name' => 'Qualification', 'description' => 'Qualification', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 74, 'name' => 'Training Coordinator', 'description' => 'Training Coordinator', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 75, 'name' => 'Implementor', 'description' => 'Implementor', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 76, 'name' => 'Line Manager', 'description' => 'Line Manager', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 77, 'name' => 'Lead Investigator', 'description' => 'Lead Investigator', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 78, 'name' => 'Safety Officer', 'description' => 'Safety Officer', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
            ['id' => 79, 'name' => 'External User', 'description' => 'External User', 'permission' => ['read' => true, 'create' => true, 'edit' => true, 'delete' => true]],
        ];
