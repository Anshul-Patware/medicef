...
Route::group(['prefix' => 'rcms'], function () {
    ...
    // Route::middleware(['rcms'])->group(
        ...
        Route::get('/rcms/exportpm-excel', [PreventiveMaintenanceController::class, 'exportPmExcel'])->name('exportPmExcel');
            ...
            Route::get('action-item_activity/{id}', [ActionItemController::class, 'activityLog']);
...
// ========================
            ...
            Route::get('deviation1', [DeviationController::class, 'deviation1'])->name('deviation1');
            ...
            Route::get('incident_activity/{id}', [IncidentController::class, 'activityLog']);
