                        ...
                        <div class="inner-block create-block">
                            <div class="head text-right mb-0">
                                <a href="{{ route('rcms.logs.show', 'pending-approver') }}" target="_blank">
                                    <i class="fa-solid fa-log"></i>Pending Training Log
                                </a>
            ...
            <form action="{{ route('division_submit') }}" method="post">
                ...
                <div class="division-tabs">
                    <div class="tab">
                        ...
                        <style>
                            #division-modal .tab a.active {
                                background-color: #eba746!important;
                    ...
                    <div id="{{ $temp->division_id }}" class="divisioncontent">
                        ...
                        @foreach ($pro as $test)
                        <label for="process">
                            <input type="radio" class="process_id_reset" for="process" value="{{ $test->id }}" name="process_id" required>
                            {{ $test->process_name }}
                        </label>
                        <label for="process">
                            <input type="radio" class="process_id_reset" for="process" value="print-request" name="process_id" required> Print / Download Request
                        </label>
                        @endforeach
                    </div>
                    @endforeach
