...
<div id="data-fields">
    <div class="container-fluid">
        ...
        <form method="POST" action="{{ route('documents.update', $document->id) }}" enctype="multipart/form-data">
            ...
            @if (str_contains(url()->previous(), 'rev-details'))
                <input type="hidden" name="redirect_review" value="yes">
            @endif
    ...
    <div class="input-fields">
        <div class="row">
            <div class="col-md-12">
                <div class="group-input">
                    ...
                    <div class="relative-container">                                            
                        <textarea name="purpose" class="myclassname" {{Helpers::isRevised($document->stage)}}>{{ $document->document_content ? $document->document_content->purpose : '' }}</textarea>
                        @component('frontend.forms.language-model')
                        @endcomponent
                    </div>
                    @foreach ($history as $tempHistory)
        ...
        <div class="col-md-12">
            <div class="group-input">
                ...
                <div class="relative-container">                                            
                    <textarea name="scope"  class="myclassname" {{Helpers::isRevised($document->stage)}}>{{ $document->document_content ? $document->document_content->scope : '' }}</textarea>
                    @component('frontend.forms.language-model')
                    @endcomponent
                </div>
                @foreach ($history as $tempHistory)
                    ...
                    <div class="group-input">
                        ...
                        <div id="reportingdiv">
                            ...
                            <div class="{{  str_contains($key, 'sub') ? 'subSingleReportingBlock' : 'singleReportingBlock' }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-10">
                                        <textarea type="text" name="reporting[]" class="myclassname" {{Helpers::isRevised($document->stage)}}>{{ $data }}</textarea>
                                    </div>
                                    <div class="col-sm-1">
                            ...
                            <div class="singleReportingBlock">
                                <div class="row">
                                    <div class="col-sm-10">
                                        <textarea type="text" name="reporting[]" class="myclassname"></textarea>
                                    </div>
                                    <div class="col-sm-1">
                                        <button class="btn btn-dark subReportingAdd">+</button>
                                    </div>
