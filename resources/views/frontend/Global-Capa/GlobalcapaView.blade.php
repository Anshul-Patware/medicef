...
<style>
    ...
    <div class="form-field-head">
        <div class="division-bar">
            ...
            {{ Helpers::getDivisionName($data->division_id) }}/ Global CAPA
        </div>
    </div>
        ...
        <div class="container-fluid">
                    ...
                    <div class="d-flex" style="gap:20px;">
                       ...
                       ?>
                        {{-- <button class="button_theme1" onclick="window.print();return false;"
                            ...
                            {{-- <button class="button_theme1"> <a class="text-white" href="{{ url('GlobalCapaAuditTrial', $data->id) }}">
                                Audit Trail </a> </button> --}}
                            <a class="button_theme1 text-white" href="{{ url('GlobalCapaAuditTrial', $data->id) }}">
                                Audit Trail
                            </a>
            ...
            <!-- ---- -------------------- -->
                ...
                <div class="top-block mt-2">
                    <div><strong> Record Name:&nbsp;</strong>Global CAPA</div>
        ...
        <div class="control-list">
            ...
            <div id="change-control-fields">
                ...
                <button class="cctablinks" onclick="openCity(event, 'CCForm15')">QAH/CQAH Approval</button>
                    ...
                    <form action="{{ route('global_globalcapaUpdate', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div id="step-form">
                                    ...
                                    <div class="row">
                                        {{-- <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input disabled type="text" name="record_number"
                                                    value="{{ Helpers::getDivisionName($data->division_id) }}/Global CAPA/{{ Helpers::year($data->created_at) }}/{{ $data->record_number ? str_pad($data->record_number->record_number, 4, "0", STR_PAD_LEFT ) : '1' }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                <label for="RLS Record Number"><b>Record Number</b></label>
                                                    ...
                                                    value="{{ Helpers::getDivisionName($data->division_id) }}/Global CAPA/{{ date('Y') }}/{{ $data->record}}">
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="col-md-6">
                                            <div class="group-input">
                                                ...
                                                <select id="select-state1" placeholder="Select..." name="assign_to"{{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : ''}} >
    ...
    <div class="inner-block-content">
        ...
        <div class="button-block">
            ...
            <button type="button"> <a href="{{ url('rcms/qms-dashboard') }}" class="text-white"> Exit </a> </button>
                            ...
                            <div id="CCForm6" class="inner-block cctabcontent">
                                <div class="inner-block-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Plan Approved By">Cancelled Comment</label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Plan Approved By">HOD Review Completed Comment</label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Plan Approved By">QA/CQA Review Completed Comment</label>
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Plan Approved By">QA/CQA Approval Completed Comment</label>
            ...
            <div class="modal fade" id="child-modal1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('global_capa_child_changecontrol', $data->id) }}" method="POST">
                            @csrf
            ...
            <div class="modal fade" id="rejection-modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('global_global_capa_reject', $data->id) }}" method="POST">
                            @csrf
                            <!-- Modal body -->
                            <div class="modal-body">
            ...
            <div class="modal fade" id="cancel-modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('global_globalCapaCancel', $data->id) }}" method="POST">
                            @csrf
                            <!-- Modal body -->
                            <div class="modal-body">
                                <div class="mb-3 text-justify">
            ...
            <div class="modal fade" id="signature-modal">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('global_global_capa_send_stage', $data->id) }}" method="POST">
                            @csrf
                            <!-- Modal body -->
                            <div class="modal-body">
                                <div class="mb-3 text-justify">
            ...
            <div class="modal fade" id="modal1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('global_global_capa', $data->id) }}" method="POST">
                            @csrf
                            <!-- Modal body -->
                            <div class="modal-body">
                                <div class="mb-3 text-justify">
