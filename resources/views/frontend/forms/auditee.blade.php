    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <div class="language-sleect d-flex" style="align-items: center; gap: 20px; margin-left: 20px;">
                <div style="margin-bottom:12px;" >Select Language </div>
                        ...
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="group-input">
                                        <label for="RLS Record Number"><b>Record Number</b></label>
                                        <input disabled type="text" name="record_number"  value="{{ Helpers::getDivisionName(session()->get('division')) }}/EA/{{ date('Y') }}/{{ $record_number }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="relative-container">
                                            <textarea name="Supplier_Details"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <div class="relative-container">
                                            <textarea name="Supplier_Site"></textarea>
                                            @component('frontend.forms.language-model')
                                            @endcomponent
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select multiple id="reference_record" name="refrence_record[]" id="">
                                            ...
                                            @foreach ($old_record as $new)
                                             @php    
                                            // Generate the formatted string value
                        ...
                        <div class="col-12 sub-head" style="font-size: 16px">
                                 Schedule Audit
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-4">
                                            <div class="group-input">
                                            <label for="Comments">Audit Schedule Comment</label>
                                                <div class="static">Not Applicable</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Preparation Completed On">Cancelled Comment</label>
                                                <div class="static">Not Applicable</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Preparation Completed On">Complete Audit
                                                Preparation 
                                                    By</label>
                                                <div class="static">Not Applicable</div>
                                            </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Preparation Completed On">Reject
                                                    By</label>
                                                <div class="static">Not Applicable</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Preparation Completed On">Reject Comment
                                                </label>
                                                <div class="static">Not Applicable</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Issue Report On">Issue Report Comment
                                                </label>
                                                <div class="static">Not Applicable</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Observation Submitted On">CAPA Plan Comment
                                                </label>
                                                <div class="static">Not Applicable</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Lead More Info Reqd By">All CAPA Closed
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Lead More Info Reqd On">All CAPA Closed
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Audit Lead More Info Reqd On">All CAPA Closed Comment
