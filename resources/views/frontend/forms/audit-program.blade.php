...
@section('container')
    ...
    <div id="change-control-fields">
     ...
     <div class="tabs-and-language d-flex align-items-center">
            ...
            <div class="language-sleect d-flex align-items-center" style="margin-left: 30px;">
                    ...
                    <div id="CCForm2" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Submitted_On">Submit Comment</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Submitted_By..">Cancel By</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Submitted_On">Cancel On</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Approved_By">More Info Required By</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Approved_On">More Info Required On</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Approved_On">More Info Required Comment</label>
                                        <div class="static"></div>
                                    </div>
                                </div>     
                                ...
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Approved_By">Cancel By</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Approved_On">Cancel On</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Approved_On">Cancel Comment</label>
                                        <div class="static"></div>
                                    </div>
                                </div>    
                                ...
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Audit_Completed_On">Audit Comment</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="group-input">
                                        <label for="Cancelled_On">Cancel Comment</label>
                                        <div class="static"></div>
                                    </div>
                                </div>
                            </div>
