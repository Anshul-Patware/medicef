...
@section('container')
    ...
    <div class="form-field-head">
        ...
        <div class="division-bar">
            ...
            {{ Helpers::getDivisionName(session()->get('division')) }} / Global CAPA
        </div>
    </div>
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
           ...
           <style>
            ...
            <form action="{{ route('globa_globalCapaStore') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div id="step-form">                                       
                    @if (!empty($parent_id))
                                ...
                                {{-- <div class="col-lg-6">
                                    {{-- <div class="group-input">
                                        ...
                                        <input disabled type="text" name="record_number"
                                            value="{{ Helpers::getDivisionName(session()->get('division')) }}/Global CAPA/{{ date('Y') }}/{{ $record_number }}">
                                        {{-- <div class="static">QMS-EMEA/Global CAPA/{{ date('Y') }}/{{ $record_number }}</div> --}}
                                    {{-- </div> --}}
                                    {{-- <div class="col-lg-6">
                                        <div class="group-input">
