    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <div class="language-sleect d-flex" style="align-items: center; gap: 20px; margin-left: 20px;">
                <div style="margin-bottom:15px;">Select Language </div>
                            ...
                            <!-------------------------------incident grid----------------->
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input" id="incident_involved_others_gi">
                                        ...
                                        <textarea name="incident_involved_others_gi" class="tiny"></textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input" id="Incident_Category_others">
                                        <label for="Incident_Category">Others<span
                                                class="text-danger d-none">*</span></label>
                                        <textarea name="Incident_Category_others" class="tiny"></textarea>
                                    </div>
                                </div>
                                 <div class="col-lg-12">
                                    <div class="group-input">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="immediate_action_ia" class="tiny"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="Incident_Details" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Document Details ">Document Details</label>
                                        <textarea name="Document_Details" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Instrument Details">Instrument Details</label>
                                        <textarea name="Instrument_Details" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Involved Personnel">Involved Personnel</label>
                                        <textarea name="Involved_Personnel" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Product Details,If Any">Product Details,If Any</label>
                                        <textarea name="Product_Details" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Supervisor Review Comments">Supervisor Review Comments</label>
                                        <textarea name="Supervisor_Review_Comments" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="group-input">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="capa_capa" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Currective Action">Corrective Action</label>
                                        <textarea name="Currective_Action" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Preventive Action">Preventive Action</label>
                                        <textarea name="Preventive_Action" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="Corrective & Preventive Action">Corrective & Preventive Action</label>
                                        <textarea name="Corrective_Preventive_Action" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="QA_Review_Comments" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="QA_Head" class="tiny"></textarea>
                                    </div>
                                </div>
                                <!-- <div class="col-lg-6">
                                    <div class="group-input">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="Conclusion" class="tiny"></textarea>
                                    </div>
                                </div>
                                <div class="col-12 sub-head">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea id="duedoc" class="tiny" name="due_date_extension" type="text" maxlength="240"></textarea>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="group-input" id="Incident_invlvolved_others">
                                                                <label for="instrument_involved_SSFI">Instrument Involved<span
                                                                        class="text-danger d-none">*</span></label>
                                                                <textarea name="involved_ssfi" class="tiny"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="group-input" id="Description_incidence_ssfi">
                                                                <label for="Description_incidence_ssfi"> Description Of Incidence<span
                                                                        class="text-danger d-none">*</span></label>
                                                                <textarea name="Description_incidence_ssfi" class="tiny"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="group-input" id="Detail_investigation_ssfi">
                                                                <label for="Detail_investigation_ssfi"> Detail Investigation<span
                                                                        class="text-danger d-none">*</span></label>
                                                                <textarea name="Detail_investigation_ssfi" class="tiny"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="group-input" id="proposed_corrective_ssfi">
                                                                <label for="proposed_corrective_ssfi"> Proposed Corrective Action<span
                                                                        class="text-danger d-none">*</span></label>
                                                                <textarea name="proposed_corrective_ssfi" class="tiny"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="group-input" id="root_cause_ssfi">
                                                                <label for="root_cause_ssfi"> Root Cause<span
                                                                        class="text-danger d-none">*</span></label>
                                                                <textarea name="root_cause_ssfi" class="tiny"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="group-input" id="incident summary ssfi">
                                                                <label for="incident summary ssfi"> Incident Summary<span
                                                                        class="text-danger d-none">*</span></label>
                                                                <textarea name="incident_summary_ssfi" class="tiny"></textarea>
                                                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="closure_incident_c" class="tiny">
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                       ...
                                       <textarea name="qc_hear_remark_c" class="tiny"></textarea>
                                    </div>
                                </div>
