                    ...
                    <div style="padding: 5px;" class="scope-bar d-flex justify-content-end py-1">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('exportcsvdvt') }}">
                                    <i class="fas fa-file-csv"></i> CSV Export
                                </a>
                                <a class="dropdown-item" href="{{ route('exportexceldvt') }}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_deviation">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_fromDeviation">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_toDeviation">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="scroll-container">
                        <div class="table-block">
                            ...
                            <div style="padding: 10px; display: flex; justify-content: space-between; align-items: center; gap: 5px;">
                                <div>
                                    <select id="dateFilter" onchange="filterByDueDate()" style="padding: 10px; border: 1px solid orange; border-radius: 5px; font-size: 14px;">
                                ...
                                <div style="position: relative; width: 300px;">
                                    <input 
                                        ...
                                        placeholder="Search..." 
                                        onkeyup="filterTable()" 
                                        style="padding: 10px 35px 10px 10px; width: 100%; border: 1px solid orange; border-radius: 5px; font-size: 14px;"
                                    >
                                    <span 
                                ...
                                <table class="table table-bordered table-hover" style="background-color: #fff; border-collapse: collapse; text-align: left;">
                                    <thead style="background-color: #797979; color: #000;">
                                        <tr>
                                            ...
                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('Initiator_Group')">Department Name</th>
...
<script>
    $(document).ready(function(){
        const filterData = {
            department_deviation: [],
            division_id_deviation: null,
            initiator_id_deviation: [],
        ...
        $('#initiator_group').change(function() {
            filterData.department_deviation = this.value;
            filterRecords();
        });
    
        $('#division_id_deviation').change('change', function() {
            filterData.division_id_deviation = this.value;
            filterRecords();
        });
    
        document.getElementById('initiator_id').addEventListener('change', function() {
            filterData.initiator_id_deviation = this.value;
            filterRecords();
        });
    
        document.getElementById('date_fromDeviation').addEventListener('change', function() {
            filterData.date_fromDeviation = this.value;
            filterRecords();
        });
    
        document.getElementById('date_toDeviation').addEventListener('change', function() {
            filterData.date_toDeviation = this.value;
            filterRecords();
        });
    // ===============local=============
...
<script>
    ...
    const changerelateTo = document.getElementById('division_id_deviation').value;
    const Initiator = document.getElementById('initiator_id').value;
    const dateFrom = document.getElementById('date_fromDeviation').value;
    const dateTo = document.getElementById('date_toDeviation').value;
  
    const url = `/api/print-Deviation?department=${department}&changerelateTo=${changerelateTo}&Initiator=${Initiator}&dateFrom=${dateFrom}&dateTo=${dateTo}`;
