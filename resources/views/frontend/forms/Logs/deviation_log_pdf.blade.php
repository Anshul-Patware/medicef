            ...
            <tr>
                <td class="w-50">
                    <div class="header-title">
                        <h3 style="margin-left: 100px">Deviation Log Report</h3>
                    </div>
                </td>
    ...
    <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('devshow', $doc->id) }}" target="_blank" style="color: rgb(000,000,000); font-weight: bold; font-size: 10px;">
                        {{ $doc->division ? $doc->division->name : ' Not Applicable ' }}<br>/DEV/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
                        </a>
                    </td>
