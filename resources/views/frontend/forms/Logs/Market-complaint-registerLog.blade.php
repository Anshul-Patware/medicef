                        ...
                        >
                            <h4 
                                style="
                                    ...
                                    color: #000;"
                            >
                            Complaint Management Log Report
                            </h4>
                        </div>
                    </div>
                </div>
                    ...
                    <div style="padding: 5px;" class="scope-bar d-flex justify-content-end py-1">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('exportcsvcomplaintcmt') }}">
                                    <i class="fas fa-file-csv"></i> CSV Export
                                </a>
                                <a class="dropdown-item" href="{{ route('exportxlscomplaintcmt') }}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div style="    display: grid;    grid-template-columns: 1fr 1fr 1fr 1fr 1fr;" class="filter-bar row">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <select class="custom-select" id="division_id_market">
                                                ...
                                                <div class=" mb-3">
                                                    ...
                                                    <input type="date" class="custom-select" id="date_frommarket">
                                                </div>
                        
                                                <!-- End Date Filter -->
                                                <div class=" mb-3">
                                                    <label for="date_to_deviation">End Date:</label>
                                                    <input type="date" class="custom-select" id="date_tomarket">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function(){
        const filterData = {
            department_market: [],
            division_id_market: null,
            initiator_id_market: [],
            date_frommarket: null,
            date_tomarket: null,
            sort_column: '',
            sort_order: ''
        };
        ...
        $('#initiator_group').change(function() {
            filterData.department_market = this.value;
            filterRecords();
        });
    
        $('#division_id_market').change('change', function() {
            filterData.division_id_market = this.value;
            filterRecords();
        });
    
        document.getElementById('initiator_id').addEventListener('change', function() {
            filterData.initiator_id_market = this.value;
            filterRecords();
        });
    
        document.getElementById('date_frommarket').addEventListener('change', function() {
            filterData.date_frommarket = this.value;
            filterRecords();
        });
    
        document.getElementById('date_tomarket').addEventListener('change', function() {
            filterData.date_tomarket = this.value;
            filterRecords();
        });
    // ===============local=============
...
<script>
    ...
    const changerelateTo = document.getElementById('division_id_market').value;
    const Initiator = document.getElementById('initiator_id').value;
    const dateFrom = document.getElementById('date_frommarket').value;
    const dateTo = document.getElementById('date_tomarket').value;
   
       const url = `/api/print-complaintM?department=${department}&changerelateTo=${changerelateTo}&Initiator=${Initiator}&dateFrom=${dateFrom}&dateTo=${dateTo}`; 
