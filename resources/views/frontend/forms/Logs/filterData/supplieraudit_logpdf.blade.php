...
<body>
            ...
            <tr>
                <td class="w-50">
                    <div class="header-title">
                        <h3 style="margin-left: 100px">Supplier Audit Log Report</h3>
                    </div>
                </td>
    ...
    <!-- <table style = "position:relative; bottom:15px; padding-bottom:0;"> -->
    <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $doc->division ? $doc->division->name : 'Not Applicable' }}/Sanction/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</td>
