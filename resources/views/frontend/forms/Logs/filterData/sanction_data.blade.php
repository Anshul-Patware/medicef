...
@forelse ($sanction as $index => $doc)
    <tr>
        ...
        <td>
            <a href="{{ route('showSanction', $doc->id) }}" style="color: rgb(236,160,53);font-weight: bold; font-size: 13px;" target="_blank" onmouseover="this.style.color='orange'" onmouseout="this.style.color='orange'">
