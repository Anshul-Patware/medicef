...
<body>
            ...
            <tr>
                <td class="w-50">
                    <div class="header-title">
                        <h3 style="margin-left: 100px">Effectiveness Check Log Report</h3>
                    </div>
                </td>
    ...
    <table>
            <tbody>
                ...
                <tr>
                <td>{{$loop->index + 1}}</td>
                <td>{{$doc->intiation_date ? $doc->intiation_date:'Not Applicable'}}</td>
                <td>{{$doc->division ? $doc->division->name : ' Not Applicable '}}/AI/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT)}}</td>
                <td>{{$doc->division ? $doc->division->name : ' Not Applicable '}}</td>
                <td>{{$doc->short_description}}</td>
                <td>{{$doc->due_date ? Carbon::parse($doc->due_date)->format('d-M-Y') : ' Not Applicable '}}</td>
