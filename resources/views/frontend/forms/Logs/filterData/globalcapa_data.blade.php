...
@forelse ($gcapas as $index => $doc)  
        ...
        <tr>
                ...
                <td>
                    <a href="{{ route('globalCapaShow', $doc->id) }}" style="color: rgb(236,160,53);font-weight: bold; font-size: 13px;" onmouseover="this.style.color='orange'" target = '_blank' onmouseout="this.style.color='orange'">
