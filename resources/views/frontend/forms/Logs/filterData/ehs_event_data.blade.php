...
@forelse ($ehs as $index => $doc)  
        ...
        <tr>
                ...
                <td>
                    <a href="{{ route('showEhs_event', $doc->id) }}" target ="_blank" style="rgb(236,160,53); font-weight: bold;font-size: 13px; " onmouseover="this.style.color='orange'" onmouseout="this.style.color='orange'">
               {{ $doc->division ? $doc->division->name : ' Not Applicable ' }}/EHS/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</a></td>
                ...
                <td>{{ $doc->Department ?: ' Not Applicable ' }}</td>
