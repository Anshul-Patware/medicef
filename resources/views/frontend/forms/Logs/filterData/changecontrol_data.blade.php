...
@forelse ($cc_cft as $index => $doc)  
    ...
    <tr>
        ...
        <td>
            <a href="{{ route('CC.show', $doc->id) }}" target="_blank" style="color: rgb(236,160,53); font-weight: bold; font-size: 13px;">
               {{ $doc->division ? $doc->division->name : ' Not Applicable ' }}/CC/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
            </a>
        </td>
