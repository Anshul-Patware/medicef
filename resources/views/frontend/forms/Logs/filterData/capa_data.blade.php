...
@forelse ($capa as $index => $doc)  
        ...
        <tr>
                ...
                <td>
                    <a href="{{ route('capashow', $doc->id) }}" style="color:  rgb(236,160,53);" onmouseover="this.style.color='orange'" onmouseout="this.style.color='orange'">
               {{ $doc->division ? $doc->division->name : ' Not Applicable ' }}/CAPA/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</a></td>
