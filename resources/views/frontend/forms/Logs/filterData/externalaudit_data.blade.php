...
@forelse ($ea as $index => $doc)  
        ...
        <tr>
                ...
                <td>
                    <a href="{{ route('showExternalAudit', $doc->id) }}" style="color: rgb(236,160,53); font-weight: bold; font-size: 13px;" onmouseover="this.style.color='orange'" target = '_blank' onmouseout="this.style.color='orange'">
               {{ $doc->division ? $doc->division->name : ' Not Applicable ' }}/EA/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}</a></td>
