                                ...
                                <table class="table table-bordered table-hover" style="background-color: #fff; border-collapse: collapse; text-align: left;">
                                    <thead style="background-color: #797979; color: #000;">
                                        <tr>
                                            ...
                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Change Control No.</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Initiator Dept.</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Date of Initiation</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Type of Change #</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Change proposed</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Nature of Change</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Accepted/Rejected</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Approval/Rejected Date</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Closure Date</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Review of Implementation <br> On/By</th>

                                            <th class="sortable" style="background-color: #eca035" onclick="sortTable('id')">Remark</th>
