...
<body>
            ...
            <tr>
                <td class="w-50">
                    <div class="header-title">
                        <strong>Preventive Maintenance Log Report</strong>
                    </div>
                </td>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $doc->criticality_level ?: ' Not Applicable ' }}</td>
    ...
    <footer>
        <table class="footer-table">
            <tr>
                <td><strong>Printed By:</strong> 
                {{ optional($doc->initiator)->name ?: 'Not Applicable' }}
                </td>
                <td><strong>Printed on:</strong> {{ date('d-M-Y') }}</td>
