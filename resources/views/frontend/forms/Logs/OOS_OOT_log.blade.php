                    ...
                    <div style="padding: 5px;" class="scope-bar d-flex justify-content-end py-1">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('exportcsvOOT')}}">
                                    <i class="fas fa-file-csv"></i> CSV Export
                                </a>
                                <a class="dropdown-item" href="{{ route('exportexceOOT')}}">
...
<script>
     function printTable() {
        ...
        const division = document.getElementById('division_id_oot').value;
        const dateFrom = document.getElementById('datefrom_oot').value;
        const dateTo = document.getElementById('dateto_oot').value;
   
   
    const url = `/api/print-oot?department=${department}&division=${division}&date_from=${dateFrom}&date_to=${dateTo}`;
