    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <div class="cctab">
                ...
                <button class="cctablinks" onclick="openCity(event, 'CCForm8')">QA/CQA Review</button>
                <button class="cctablinks" onclick="openCity(event, 'CCForm9')">CFT Review</button>
                <button class="cctablinks" onclick="openCity(event, 'CCForm13')">QA/CQA Approval</button>
                     ...
                     <div id="CCForm13" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        <label for="Closure Comment">QA/CQA Approve Comment</label>
                                        <div><small class="text-primary">Please insert "NA" in the data field if it
                                                does not
                                                require completion</small></div>
                                        <textarea class="summernote" name="qa_cqa_app_com" id="qa_cqa_app_com"> </textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="CAPA Attachments"> QA/CQA Approve Attachments</label>
                                        <div><small class="text-primary">Please Attach all relevant or supporting
                                                documents</small></div>
                                        {{-- <input multiple type="file" id="myfile" name="capa_attachment[]"> --}}
                                        <div class="file-attachment-field">
                                            <div class="file-attachment-list" id="qa_cqa_app_attach"></div>
                                            <div class="add-btn">
                                                <div>Add</div>
                                                <input type="file" id="myfile" name="qa_cqa_app_attach[]"
