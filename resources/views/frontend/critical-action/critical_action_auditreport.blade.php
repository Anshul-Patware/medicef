    ...
    <header>
        <table>
            <tr>
                ...
                <td class="w-30">
                    <div class="logo">
                        <img src="https://www.medicefpharma.com/wp-content/uploads/2020/06/medicef-logo-new1.png" alt="" class="w-80" style="scale: 0.5" >
        ...
        <table>
            <tr>
                <td class="w-30">
                    <strong>Critical Action No.</strong>
                </td>
                <td class="w-40">
                   {{ Helpers::getDivisionName($doc->division_id) }}/Critical Action/{{ Helpers::year($doc->created_at)}}/ {{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
