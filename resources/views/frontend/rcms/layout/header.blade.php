    ...
    <header>
                ...
                <div class="container-fluid">
                    <div class="middle-head">
                        <div class="logo-container" style="display: flex; align-items: center; justify-content: start;">
                            ...
                            <div class="logo">
                                <img src="https://www.medicefpharma.com/wp-content/uploads/2020/06/medicef-logo-new1.png" alt="Medicef Pharma Logo"
                        ...
                        <span id="header-timer" class="timer-display">Timer: 00:00:00</span>
                            ...
                            <div class="profile-image">
                                ...
                                @else
                                    <i class="fa-solid fa-user-tie" style="font-size: 1rem;"></i> <!-- Default icon displayed when no image -->
                                @endif
                            </div>
                            <div>
                                @if (Auth::user())
      ...
      <script>
        ...
        <div class="header_rcms_bottom">
            ...
            <div class="header-bottom" style="font-size: 90%;">
                <div class="container-fluid overflow-head">
                    <div class="bottom-links overflow-header" style="font-size: 87%;">
                        ...
                        <div>
                         <a href="/department-analysis" class="{{ Request::is('department-analysis') ? 'active' : '' }}">Quality Dashboard</a>
                       </div>
                        <div>
