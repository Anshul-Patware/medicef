                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                @elseif ($datas->type == 'Risk Assessment')
                                                    ...
                                                    @endif
                                                @elseif ($datas->type == 'Equipment Lifecycle Management')
                                                ...
                                                @elseif($datas->type == 'Capa')
                                                    ...
                                                    <a href="{{ url('globalCapaShow', $datas->id) }}" style="color:  rgb(43, 43, 48)">
                                                        {{ str_pad(($total_count - $loop->index), 4, '0', STR_PAD_LEFT) }}
                                                    </a>
                                                    @if (!empty($datas->parent_id))
                                                ...
                                                @elseif($datas->type == 'OOT')
                                                    ...
                                                    @elseif($datas->type == 'Recall Process')
                                                    <a href="{{ route('recall_view', $datas->id) }}" style="color:  rgb(43, 43, 48)">
                                                        {{ str_pad(($total_count - $loop->index), 4, '0', STR_PAD_LEFT) }}
                                                    </a>
                                                    {{-- @if (!empty($datas->parent_id))
                                                        <a
