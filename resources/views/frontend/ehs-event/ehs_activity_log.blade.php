                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Submit By:</strong><br>
                                    {{ $data->Submit_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Submit On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Submit Comments:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Cancel By:</strong><br>
                                    {{ $data->Cancelled_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Cancel On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Cancel Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Review Complete By:</strong><br>
                                    {{ $data->Review_Complete_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Review Complete On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Review Complete Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">More Information Required By:</strong><br>
                                    {{ $data->More_Info_Required_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">More Information Required On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">More Information Required Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Complete Investigation By:</strong><br>
                                    {{ $data->Complete_Investigation_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Complete Investigation On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Complete Investigation Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">More Investigation Required By:</strong><br>
                                    {{ $data->More_Investigation_Req_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">More Investigation Required On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">More Investigation Required Comment:</strong><br>
                                    {{ $data->More_Investigation_Req_Comment ?? 'Not Applicable' }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Analysis Complete By:</strong><br>
                                    {{ $data->Analysis_Complete_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Analysis Complete On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Analysis Complete Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Training Required By:</strong><br>
                                    {{ $data->Training_required_by ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Training Required On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Training Required Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Training Complete By:</strong><br>
                                    {{ $data->Training_complete_by ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Training Complete On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Training Complete Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Propose Plan By:</strong><br>
                                    {{ $data->Propose_Plan_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Propose Plan On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Propose Plan Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Reject By:</strong><br>
                                    {{ $data->Reject_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Reject On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Reject Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">Approve Plan By:</strong><br>
                                    {{ $data->Approve_Plan_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">Approve Plan On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">Approve Plan Comment:</strong><br>
                            ...
                            <tr>
                                <td>
                                    <strong style="color: #eca035">All CAPA Closed By:</strong><br>
                                    {{ $data->All_CAPA_Closed_By ?? 'Not Applicable' }}
                                </td>
                                <td>
                                    <strong style="color: #eca035">All CAPA Closed On:</strong><br>
                                    @php
                            ...
                            <tr>
                                <td colspan="2">
                                    <strong style="color: #eca035">All CAPA Closed Comment:</strong><br>
