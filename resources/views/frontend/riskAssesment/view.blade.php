    ...
    ======================================= --}}
                                ...
                                @endif
                                    ...
                                    @if ($data->stage == 2 || $data->stage == 3)
                                        ...
                                        <div class="col-md-6 mb-3 CQA">
                                            <div class="group-input">
                                                <label for="Corporate Quality Assurance Review Completed By ">Corporate Quality Assurance Review Completed By</label>
                                                <input readonly type="text"
                                        ...
                                        <div class="col-lg-6 CQA new-date-data-field">
                                            <div class="group-input input-date">
                                                <label for="Corporate Quality Assurance Review Completed on">Corporate Quality Assurance Review Completed on</label>
                                                <div class="calenderauditee">
                            ...
                            <div class="inner-block-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        @if ($data->stage == 5)
                                        <div class="group-input">
                                            <label for="Closure Comment">QA/CQA Approval Comment <span
                                                    class="text-danger">*</span></label>
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea class="summernote" name="qa_cqa_app_com"
                                                id="summernote-1"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>{{ $data->qa_cqa_app_com }}</textarea>
                                        </div>
                                        @else
                                        <div class="group-input">
                                            <label for="Closure Comment">QA/CQA Approval Comment <span
                                            ...
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea readonly  class="summernote" name="qa_cqa_app_com"
                                                id="summernote-1"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>{{ $data->qa_cqa_app_com }}</textarea>
                                        </div>
                                        @endif
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            <label for="Inv Attachments">QA/CQA Approve Attachment</label>
                                            <div>
                                                <small class="text-primary">
                                                    Please Attach all relevant or supporting documents
                                                </small>
                                            ...
                                            <div class="file-attachment-field">
                                                <div class="file-attachment-list" id="qa_cqa_app_attach">

                                                    @if ($data->qa_cqa_app_attach)
                                                        @foreach (json_decode($data->qa_cqa_app_attach) as $file)
                                                            <h6 type="button" class="file-container text-dark"
                                                                style="background-color: rgb(243, 242, 240);">
                                                                <b>{{ $file }}</b>
                                                                <a href="{{ asset('upload/' . $file) }}"
                                                ...
                                                <div class="add-btn">
                                                    <div>Add</div>
                                                    <input {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}
                                                        type="file" id="qa_cqa_app_attach"
                                                        name="qa_cqa_app_attach[]"
                                                        oninput="addMultipleFiles(this,'qa_cqa_app_attach')" multiple>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="group-input">
                                            ...
                                            <div class="file-attachment-field">
                                                <div disabled class="file-attachment-list" id="qa_cqa_app_attach">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="group-input">
                                            ...
                                            <div class="static">{{ $data->cft_comments ?? 'Not Applicable' }}</div>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            newRow.setAttribute("id", "row" + currentRowCount);
                ...
                cell5.innerHTML = "<textarea name='existing_risk_control[]' type='text'>";
                ...
                cell11.innerHTML = "<textarea name='risk_control_measure[]' type='text'>";
                ...
                cell17.innerHTML = "<textarea name='mitigation_proposal[]' type='text'>";
