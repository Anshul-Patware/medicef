...
<body>
    ...
    <header>
        <table>
            <tr>
                <td class="w-80 head">
                     Recall Process Audit Trail Report
                </td>
                <td class="w-20">
                    <div class="logo">
                        <img src="https://www.cphi-online.com/Medicef%20Logo-comp306798.jpg" alt="logo" class="w-80">
                    </div>
                </td>
            </tr>
        </table>
        <table>
            <tr>
                <td class="w-40">
                    <strong> Recall Process No.</strong>
                </td>
                 <td class="w-40">
                    ...
                    @foreach ( $data as $index => $dataDemo)
                        <tr>
                            ...
                            <td class="w-30">
                                ...
                                <div class="allow-wb">
                                    @if ($dataDemo->activity_type == 'Activity Log')
                                        <strong>Change To :</strong><span
                                        style="word-break: break-all; max-width: 20px;">
                                    ...
                                    @else
                                        <strong>Change To :</strong><span
                                        style="word-break: break-all; width: 20px; word-wrap: break-word;">
