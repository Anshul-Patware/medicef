            ...
            <body>
                ...
                @php
                    $auditCollect = DB::table('audit_reviewers_details')
                        ...
                        ->latest()
                        ->first();
                @endphp <div style="display: flex; justify-content: flex-end;">

                    <button class="button_theme1" data-bs-toggle="modal"
                        data-bs-target="#auditReviewer"style="margin-right: 10px">
                        Review
                    </button>
                    <button class="button_theme1" data-bs-toggle="modal"
                        data-bs-target="#auditViewers"style="margin-right: 10px">
                        View
                    </button>
                    <a class="button_theme1 text-white" href="{{ route('showrecallprocess', $data->id) }}"
                        style="margin-right: 10px"> Back </a>


                    <a class="button_theme1 text-white" href="{{ url('rcms/qms-dashboard') }}"style="margin-right: 10px">
                        Exit
                    </a>
            ...
            <table>
                <div class="heading">
                    ...
                    <div style="margin-bottom: 5px;  font-weight: bold;">Due Date :
                        {{ Helpers::getdateFormat($document->due_date) }}</div>
