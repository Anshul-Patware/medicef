...
@section('rcms_container')
        ...
        <div class="container-fluid">
            <div class="inner-block">
                ...
                <div class="slogan">
                    ...
                    {{ Helpers::getDivisionName($equipment->division_id) }} / Recall Process
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="change-control-view">
        <div class="container-fluid">
            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1">
                            <a class="text-white" href="{{ route('RecallProcessAuditTrail', $data->id) }}">
                                Audit Trail
                            </a>
                        </button>
                ...
                <br>
                <div class="top-block">
                    <div><strong> Record Name :&nbsp;</strong>Recall Process</div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-titles ml-10">Recall Process Workflow</h4>
                        </div>
        ...
        <div class="control-list">
            ...
            <div id="change-control-fields">
                ...
                <button class="cctablinks" onclick="openCity(event, 'CCForm3')">Calibration Details</button> --}}
                        <button class="cctablinks" onclick="openCity(event, 'CCForm1')">Recall overviews</button>
                ...
                <button class="cctablinks" onclick="openCity(event, 'CCForm9')">Equipment Retirement</button> --}}
                    ...
                    <form id="CCFormInput" action="{{ route('updateRecallProcess', $data->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <select name="depart_group" id="depart_group" class="input_style">
                                                    ...
                                                    <option value="Quality Assurance Biopharma"
                                                        @if ($data->depart_group == 'Quality Assurance Biopharma') selected @endif>
                                                        Quality
                                                        Assurance Biopharma</option>
                                                    <option value="Corporate Quality Assurance"
                                                        @if ($data->depart_group == 'Corporate Quality Assurance') selected @endif>
                                                        Corporate Quality Assurance</option>

                                                    <option value="Central Quality Control"
                                                        @if ($data->depart_group == 'Central Quality Control') selected @endif>
                                                        Central Quality Control</option>
                                                    <option value="Manufacturing"
                                                        @if ($data->depart_group == 'Manufacturing') selected @endif>
                                                        Manufacturing</option>
                                                    <option value="Plasma Sourcing Group"
                                                        @if ($data->depart_group == 'Plasma Sourcing Group') selected @endif>
                                                        Plasma Sourcing Group</option>
                                                    <option value="Central Stores">
                                                        Central Stores</option>
                                                    <option value="Information Technology Group"
                                                        @if ($data->depart_group == 'Information Technology Group') selected @endif>
                                                        Information Technology Group</option>
                                                    <option
                                                        value="Molecular Medicine"@if ($data->depart_group == 'Molecular Medicine') selected @endif>
                                                        Molecular Medicine</option>
                                                    <option
                                                        value="Central Laboratory"@if ($data->depart_group == 'Central Laboratory') selected @endif>
                                                        Central Laboratory</option>
                                                    <option
                                                        value="Tech Team"@if ($data->depart_group == 'Tech Team') selected @endif>
                                                        Tech Team</option>
                                                    <option
                                                        value="Quality Assurance"@if ($data->depart_group == 'Quality Assurance') selected @endif>
                                                        Quality Assurance</option>
                                                    <option
                                                        value="Quality Management"@if ($data->depart_group == 'Quality Management') selected @endif>
                                                        Quality Management</option>
                                                    <option
                                                        value="IT Administration"@if ($data->depart_group == 'IT Administration') selected @endif>
                                                        IT Administration</option>
                                                    <option
                                                        value="Accounting"@if ($data->depart_group == 'Accounting') selected @endif>
                                                        Accounting</option>
                                                    <option
                                                        value="Logistics"@if ($data->depart_group == 'Logistics') selected @endif>
                                                        Logistics</option>
                                                    <option
                                                        value="Senior Management"@if ($data->depart_group == 'Senior Management') selected @endif>
                                                        Senior Management</option>
                                                    <option
                                                        value="Business Administration"@if ($data->depart_group == 'Business Administration') selected @endif>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text"id="depart_group_code" name="depart_group_code"
                                                    value="{{ $data->depart_group_code }}" class="input_style"
                                                    readonly />
                                            </div>
                                        </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="short_description" id="docname" type="text"
                                                        value="{{ $equipment->short_desc }}" maxlength="255" required
                                                        {{ $equipment->stage == 0 || $equipment->stage == 9 ? 'disabled' : '' }}>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="number" id="batch" name="batch_lot_no"
                                                    value="{{ $data->batch_lot_no }}" class="input_style" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                <label for="recall_id" class="field_style"> Recall Classification </label>
                                                <input type="text"id="recall_id" name="classification"
                                                    value="{{ $data->recall_classifi }}" class="input_style" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                <label for="recall_id" class="field_style"> Recall Initiation Date
                                                </label>
                                                <input type="date"id="recall_id" name="init_date" class="input_style"
                                                    value="{{ $data->recall_init_date }}" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <small style="color: blue">Please insert "NA" in the data field if it does not
                                                ...
                                                completion</small>
                                            <div>
                                                <textarea id="reason" class="mt-3" style="width: 100%" name="rea_for_recall" rows="3">{{ $data->reason_for_recall }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <small style="color: blue">Please insert "NA" in the data field if it does not
                                                ...
                                                completion</small>
                                            <div class="col-lg-12">
                                                <textarea id="recall_id" class="mt-3" style="width: 100%" name="recall_scope" rows="3">{{ $data->recall_scope }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="group-input">
                                            ...
                                            <div class="file-attachment-field">
                                                ...
                                                <div class="add-btn">
                                                    ...
                                                    <input
                                                        {{ $equipment->stage == 0 || $equipment->stage == 9 ? 'disabled' : '' }}
                                                        type="file" id="myfile" name="recall_attach[]"
                                            ...
                                            <div class="group-input">
                                                ...
                                                <table class="table table-bordered" id="equi_details_new_n">
                                                    ...
                                                    <tbody>
                                                        dd($data3)
                                                        {{-- @if (!empty($data3))
                                                            @foreach (unserialize($data3) as $key => $temps)
                                                                <tr>
                                                                    <td>
                                                                        <input type="" name="serial_number[]"
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="equipment[]"
                                                                            {{ $data->stage == 0 || $data->stage == 9 ? 'disabled' : '' }}
                                                                            value="{{ unserialize($temps->equipment_name)[$key] ?? '' }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="equipment_instruments[]"
                                                                            {{ $data->stage == 0 || $data->stage == 9 ? 'disabled' : '' }}
                                                                            value="{{ unserialize($data3->equipment_instruments)[$key] ?? '' }}">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" name="equipment_comments[]"
                                                                            {{ $data->stage == 0 || $data->stage == 9 ? 'disabled' : '' }}
                                        ...
                                        <script>
                                            $(document).ready(function() {
                                                $('#equipment_add_new').click(function(e) {
                                                    ...
                                                    var lastSerialNumber = parseInt($(
                                                        '#equi_details_new_n tbody tr:last input[name="serial_number[]"]').val());
                                    ...
                                    <div class="row">
                                                                ...
                                                                @foreach (unserialize($data->risk_factor) as $key => $riskFactor)
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       f             2</option>
                                                                        ...
                                                                        <td>
                                                                            <input name="initial_rpn[]"
                                                                                class='initial-rpn' readonly
                                                                        ...
                                                                        <td>
                                                                            <input name="residual_rpn[]"
                                                                                class='residual-rpn' readonly
                                                ...
                                                <div class="file-attachment-field">
                                                    ...
                                                    <div class="add-btn">
                                                        ...
                                                        <input
                                                            ...
                                                            oninput="addMultipleFiles(this, 'supporting_documents')"
                                                            multiple>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <select name="iq_test_plan" id="iq_test_plan">
                                                    ...
                                                    <option value="Electrical"
                                                        {{ $equipment->iq_test_plan == 'Electrical' ? 'selected' : '' }}>
                                                        Electrical</option>
                                                    <option value="Mechanical"
                                                        {{ $equipment->iq_test_plan == 'Mechanical' ? 'selected' : '' }}>
                                                        Mechanical</option>
                                                    <option value="Environmental"
                                                        {{ $equipment->iq_test_plan == 'Environmental' ? 'selected' : '' }}>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="iq_protocol" id="iq_protocol"
                                                        value="{{ $equipment->iq_protocol }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="iq_execution" id="iq_execution"
                                                        value="{{ $equipment->iq_execution }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="iq_report" id="iq_report"
                                                        value="{{ $equipment->iq_report }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <select name="dq_test_plan" id="dq_test_plan">
                                                    <option value="">-- Select --</option>
                                                    <option value="Electrical"
                                                        {{ $equipment->dq_test_plan == 'Electrical' ? 'selected' : '' }}>
                                                        Electrical</option>
                                                    <option value="Mechanical"
                                                        {{ $equipment->dq_test_plan == 'Mechanical' ? 'selected' : '' }}>
                                                        Mechanical</option>
                                                    <option value="Environmental"
                                                        {{ $equipment->dq_test_plan == 'Environmental' ? 'selected' : '' }}>
                                                        Environmental</option>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="dq_protocol" id="dq_protocol"
                                                        value="{{ $equipment->dq_protocol }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="dq_execution" id="dq_execution"
                                                        value="{{ $equipment->dq_execution }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="dq_report" id="dq_report"
                                                        value="{{ $equipment->dq_report }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="oq_test_plan" id="oq_test_plan"
                                                        value="{{ $equipment->oq_test_plan }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="oq_protocol" id="oq_protocol"
                                                        value="{{ $equipment->oq_protocol }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="oq_execution" id="oq_execution"
                                                        value="{{ $equipment->oq_execution }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="oq_report" id="oq_report"
                                                        value="{{ $equipment->oq_report }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="pq_test_plan" id="pq_test_plan"
                                                        value="{{ $equipment->pq_test_plan }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="pq_protocol" id="pq_protocol"
                                                        value="{{ $equipment->pq_protocol }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="pq_execution" id="pq_execution"
                                                        value="{{ $equipment->pq_execution }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="relative-container">
                                                    <input name="pq_report" id="pq_report"
                                                        value="{{ $equipment->pq_report }}"></input>
                                                    @component('frontend.forms.language-model')
                                                    @endcomponent
                                                </div>
                                            </div>
                                                ...
                                                <div class="file-attachment-field">
                                                    ...
                                                    <div class="add-btn">
                                                        ...
                                                        <input
                                                            ...
                                                            oninput="addMultipleFiles(this, 'migration_attachment')"
                                                            multiple>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                <label for="Configuration Specification Attachment">Configuration
                                                    Specification Attachment</label>
                                                <div><small class="text-primary">Please Attach all relevant or supporting
                                                        documents</small></div>

                                                <div class="file-attachment-field">
                                                    <div class="file-attachment-list"
                                                        id="configuration_specification_attachment">
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <div class="file-attachment-field">
                                                    <div class="file-attachment-list"
                                                        id="requirement_traceability_attachment">
                                        ...
                                        <div class="col-lg-6 new-date-data-field">
                                            <div class="group-input input-date">
                                                <label for="Periodic Qualification Pending On">Periodic Qualification
                                                    Pending On</label>
                                                <div class="calenderauditee">
                                                    <input type="text" id="periodic_qualification_pending_on" readonly
                                                        placeholder="DD-MMM-YYYY"
                                                        value="{{ Helpers::getdateFormat($equipment->periodic_qualification_pending_on) }}"
                                                        {{ $equipment->stage == 0 || $equipment->stage == 9 ? 'disabled' : '' }} />
                                                    <input type="date" id="periodic_qualification_pending_on_checkdate"
                                                        name="periodic_qualification_pending_on"
                                                        max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                        {{ $equipment->stage == 0 || $equipment->stage == 9 ? 'disabled' : '' }}
                                                        value="{{ $equipment->periodic_qualification_pending_on }}"
                                                        class="hide-input"
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <input name="periodic_qualification_notification"
                                                    id="periodic_qualification_notification"
                                                    value="{{ $equipment->periodic_qualification_notification }}"></input>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_standard_preference"
                                                    value="{{ $equipment->calibration_standard_preference }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="callibration_frequency">
                                                    ...
                                                    <option value="Weekly"
                                                        {{ $equipment->callibration_frequency == 'Weekly' ? 'selected' : '' }}>
                                                        Weekly</option>
                                                    <option value="Fortnightly"
                                                        {{ $equipment->callibration_frequency == 'Fortnightly' ? 'selected' : '' }}>
                                                        Fortnightly</option>
                                                    <option value="Monthly"
                                                        {{ $equipment->callibration_frequency == 'Monthly' ? 'selected' : '' }}>
                                                        Monthly</option>
                                                    <option value="Quarterly"
                                                        {{ $equipment->callibration_frequency == 'Quarterly' ? 'selected' : '' }}>
                                                        Quarterly</option>
                                                    <option value="Half Yearly"
                                                        {{ $equipment->callibration_frequency == 'Half Yearly' ? 'selected' : '' }}>
                                                        Half Yearly</option>
                                                    <option value="Annually"
                                                        {{ $equipment->callibration_frequency == 'Annually' ? 'selected' : '' }}>
                                                        Annually</option>
                                                    <option value="Once in Two Years"
                                                        {{ $equipment->callibration_frequency == 'Once in Two Years' ? 'selected' : '' }}>
                                            ...
                                            <div class="group-input input-date">
                                                ...
                                                <div class="calenderauditee">
                                                    <input type="text" id="last_calibration_date" readonly
                                                        placeholder="DD-MMM-YYYY"
                                                        value="{{ Helpers::getdateFormat($equipment->last_calibration_date) }}"
                                                        {{ $equipment->stage == 0 || $equipment->stage == 9 ? 'disabled' : '' }} />
                                            ...
                                            <div class="group-input input-date">
                                                ...
                                                <div class="calenderauditee">
                                                    <input type="text" id="next_calibration_date" readonly
                                                        placeholder="DD-MMM-YYYY"
                                                        value="{{ Helpers::getdateFormat($equipment->next_calibration_date) }}"
                                                        {{ $equipment->stage == 0 || $equipment->stage == 9 ? 'disabled' : '' }} />
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_due_reminder"
                                                    value="{{ $equipment->calibration_due_reminder }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_used"
                                                    value="{{ $equipment->calibration_used }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_parameter"
                                                    value="{{ $equipment->calibration_parameter }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="event_based_calibration">
                                                    <option value="">--Select--</option>
                                                    <option value="Yes"
                                                        {{ $equipment->event_based_calibration == 'Yes' ? 'selected' : '' }}>
                                                        Yes</option>
                                                    <option value="No"
                                                        {{ $equipment->event_based_calibration == 'No' ? 'selected' : '' }}>
                                                        No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="event_refernce_no"
                                                    value="{{ $equipment->event_refernce_no }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_checklist"
                                                    value="{{ $equipment->calibration_checklist }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_result"
                                                    value="{{ $equipment->calibration_result }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_certificate_result"
                                                    value="{{ $equipment->calibration_certificate_result }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_due_alert"
                                                    value="{{ $equipment->calibration_due_alert }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input type="text" name="calibration_cost"
                                                    value="{{ $equipment->calibration_cost }}">
                                            </div>
                                        </div>
                                            ...
                                            <div class="group-input">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" style="width: 200%"
                                                        ...
                                                        <thead>
                                                            <tr
                                                                style="text-align: center; vertical-align: middle; padding: 20px;">
                                                                <th rowspan="3">Row #</th>
                                                                <th colspan="34" rowspan="2">Spare Part Details
                                                                </th>
                                                                <th colspan="22" rowspan="2">Inventory Information
                                                                </th>
                                                                <th colspan="14" rowspan="2">Supplier Information
                                                                </th>
                                                            ...
                                                            <tr
                                                                ...
                                                                <th colspan="2">OEM (Original Equipment Manufacturer)
                                                                </th>
                                                            ...
                                                            @if (!empty($data->SpareEquipment_Name))
                                                                @foreach (unserialize($data->SpareEquipment_Name) as $key => $SpareEquipmentName)
                                                                    <tr>
                                                                        <td>{{ $key + 1 }}</td>
                                                                        <td colspan="2">
                                                                            <input name="SpareEquipment_Name[]"
                                                                                type="text"
                                                                                value="{{ $SpareEquipmentName }}"
                                                                                {{ $data->stage == 0 || $data->stage == 9 ? 'disabled' : '' }}>
                                                                        </td>
                                                                        <td colspan="2">
                                                                            <input name="SpareEquipment_ID[]"
                                                                                type="text"
                                                                        ...
                                                                        <td colspan="2">
                                                                            <input
                                                                                name="SpareSupplier_Warranty_Information[]"
                                                                                type="text"
                                                                        ...
                                                                        <td colspan="2">
                                                                            <input
                                                                                name="SpareSupplier_Performance_Metrics[]"
                                                                                type="text"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="training_required">
                                                    <option value="">--Select--</option>
                                                    <option value="Yes"
                                                        {{ $equipment->training_required == 'Yes' ? 'selected' : '' }}>Yes
                                                    </option>
                                                    <option value="No"
                                                        {{ $equipment->training_required == 'No' ? 'selected' : '' }}>No
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <div class="file-attachment-field">
                                                    ...
                                                    <div class="add-btn">
                                                        ...
                                                        <input
                                                            ...
                                                            oninput="addMultipleFiles(this, 'Supervisor_document')"
                                                            multiple>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="CCForm9" class="inner-block cctabcontent">
                                <div class="inner-block-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="group-input">
                                                ...
                                                <select name="Equipment_Lifecycle_Stage">
                                                    ...
                                                    <option value="In-use"
                                                        {{ $equipment->Equipment_Lifecycle_Stage == 'In-use' ? 'selected' : '' }}>
                                                        In-use</option>
                                                    <option value="Out-of-service"
                                                        {{ $equipment->Equipment_Lifecycle_Stage == 'Out-of-service' ? 'selected' : '' }}>
                                                        Out-of-service</option>
                                                    <option value="Retired"
                                                        {{ $equipment->Equipment_Lifecycle_Stage == 'Retired' ? 'selected' : '' }}>
                                                        Retired</option>
                                            ...
                                            <div class="group-input input-date">
                                                ...
                                                <div class="calenderauditee">
                                                    <input type="text" id="End_of_life_Date" readonly
                                                        placeholder="DD-MMM-YYYY" />
                                                    <input type="date" id="End_of_life_Date_checkdate"
                                        ...
                                        <div class="col-12">
                                            <div class="group-input">
                                                <label for="Decommissioning and Disposal Records">Decommissioning and
                                                    Disposal Records</label>
                            ...
                            <div id="CCForm10" class="inner-block cctabcontent">
                                <div class="inner-block-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="group-input">
                                                <label for="Supervisor Approval By">Additional Work Required
                                                    Comment</label>
    ...
    <div class="modal fade" id="signature-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('RecallProcessStateChange', $equipment->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
    ...
    <script>
        ...
        function addHAZOPRiskAssessment(tableId) {
            ...
            cell2.innerHTML =
                "<input name='deviation[]' type='text' colspan='2' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell3 = newRow.insertCell(2);
            cell3.setAttribute('colspan', '2');
            cell3.innerHTML =
                "<input name='session[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell4 = newRow.insertCell(3);
            cell4.setAttribute('colspan', '2');
            cell4.innerHTML =
                "<input name='causes[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell5 = newRow.insertCell(4);
            cell5.setAttribute('colspan', '2');
            cell5.innerHTML =
                "<input name='consequences[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell6 = newRow.insertCell(5);
            cell6.setAttribute('colspan', '2');
            cell6.innerHTML =
                "<input name='category[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell7 = newRow.insertCell(6);
            cell7.innerHTML =
                "<input name='risk_or_S[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell8 = newRow.insertCell(7);
            cell8.innerHTML =
                "<input name='risk_or_F[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell9 = newRow.insertCell(8);
            cell9.innerHTML =
                "<input name='risk_or_RR[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell10 = newRow.insertCell(9);
            cell10.setAttribute('colspan', '2');
            cell10.innerHTML =
                "<input name='risk_enablers[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell11 = newRow.insertCell(10);
            cell11.innerHTML =
                "<input name='risk_CR_S[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell12 = newRow.insertCell(11);
            cell12.innerHTML =
                "<input name='risk_CR_F[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell13 = newRow.insertCell(12);
            cell13.innerHTML =
                "<input name='risk_CR_RR[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell14 = newRow.insertCell(13);
            cell14.setAttribute('colspan', '2');
            cell14.innerHTML =
                "<input name='safeguards_sensor_tag_nr[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell15 = newRow.insertCell(14);
            cell15.setAttribute('colspan', '2');
            cell15.innerHTML =
                "<input name='safeguards_tag_nr[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell16 = newRow.insertCell(15);
            cell16.setAttribute('colspan', '2');
            cell16.innerHTML =
                "<input name='safeguards_action[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell17 = newRow.insertCell(16);
            cell17.setAttribute('colspan', '2');
            cell17.innerHTML =
                "<input name='safeguards_effective_action[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell18 = newRow.insertCell(17);
            cell18.setAttribute('colspan', '2');
            cell18.innerHTML =
                "<input name='safeguards_other_safeguards[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell19 = newRow.insertCell(18);
            cell19.setAttribute('colspan', '2');
            cell19.innerHTML =
                "<input name='critical_safeguards_description[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell20 = newRow.insertCell(19);
            cell20.innerHTML =
                "<input name='critical_safeguards_type[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell21 = newRow.insertCell(20);
            cell21.innerHTML =
                "<input name='critical_safeguards_rrf[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell22 = newRow.insertCell(21);
            cell22.innerHTML =
                "<input name='risk_rating_s[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell23 = newRow.insertCell(22);
            cell23.innerHTML =
                "<input name='risk_rating_f[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell24 = newRow.insertCell(23);
            cell24.innerHTML =
                "<input name='risk_rating_rr[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell25 = newRow.insertCell(24);
            cell25.setAttribute('colspan', '3');
            cell25.innerHTML =
                "<input name='hazop_recommendations[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell26 = newRow.insertCell(25);
            cell26.setAttribute('colspan', '3');
            cell26.innerHTML =
                "<input name='responsibility_for_recommendations[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell27 = newRow.insertCell(26);
            cell27.innerHTML =
                "<input name='risk_rating_after_s[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell28 = newRow.insertCell(27);
            cell28.innerHTML =
                "<input name='risk_rating_after_f[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";

            var cell29 = newRow.insertCell(28);
            cell29.innerHTML =
                "<input name='risk_rating_after_rr[]' type='text' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>";
            ...
            cell30.innerHTML =
                "<button type='button' onclick='removeHAZOPRow(this)' class='removeRowBtn' {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>Remove</button>";
