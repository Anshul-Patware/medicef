...
<body>
    ...
    <header>
        <table>
            <tr>
                <td class="w-70 head">
                    Recall Process Single Report
                </td>
                <td class="w-30">
                    <div class="logo">
                        <img src="https://www.cphi-online.com/Medicef%20Logo-comp306798.jpg" alt=""
                        {{-- <img src="../user/images/Medicef_Logo.jpg" alt="" --}}
                            class="w-80">
                    </div>
                </td>
            </tr>
        ...
        <table>
            <tr>
                <td class="w-30">
                    <strong>Recall No.</strong>
                </td>
                <td class="w-40">
                    {{-- {{ $data->division ? $data->division : '-' }}/Recall Process/{{ Helpers::year($data->created_at) }}/{{ str_pad($data->record, 4, '0', STR_PAD_LEFT) }} --}}
                     {{ Helpers::getDivisionName($data->division_id) }}/Recall Process/{{ Helpers::year($data->created_at) }}/{{ str_pad($data->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
            ...
            <div class="block">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                            @if ($data->depart_group_code)
                                {{ $data->depart_group_code }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <th class="w-20">Recall Initiation Date </th>
                        <td class="w-80">
                            @if ($data->recall_init_date)
                                {{ Helpers::getdateFormat($data->recall_init_date) }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        <th class="w-20">Recall Classification </th>
                        <td class="w-80">
                            @if ($data->recall_classifi)
                                {{ $data->recall_classifi }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                    ...
                    <tr>
                        <th class="w-20">Reason for Recall </th>
                        <td class="w-80">
                            @if ($data->reason_for_recall)
                    ...
                    <tr>
                        <th class="w-20">Reason Scope </th>
                        <td class="w-80">
                            @if ($data->recall_scope)
                                {{ $data->recall_scope }}
                            @else
                                Not Applicable
                            @endif
