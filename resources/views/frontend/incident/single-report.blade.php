        ...
        <table>
            <tr>
                ...
                <td class="w-40">
                    ...
                    {{ Helpers::divisionNameForQMS($data->division_id) }}/INCIDENT/{{ Helpers::year($data->created_at) }}/{{ str_pad($data->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
                                ...
                                <td class="w-30">
                                    <div>
                                        @if ($data1->production_on)
                                            {{ Helpers::getdateFormat($data1->production_on) }}
                                        @else
                                            Not Applicable
                                        @endif
                                    </div>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if ($data1->Warehouse_Review_Completed_On)
                                                {{ Helpers::getdateFormat($data1->Warehouse_Review_Completed_On) }}
                                            @else
                                                Not Applicable
                                            @endif
                                        </div>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if ($data1->Engineering_on)
                                                {{ Helpers::getdateFormat($data1->Engineering_on) }}
                                            @else
                                                Not Applicable
                                            @endif
                                        </div>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if ($data1->Analytical_Development_on)
                                                {{ Helpers::getdateFormat($data1->Analytical_Development_on) }}
                                            @else
                                                Not Applicable
                                            @endif
                                        </div>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if ($data1->Kilo_Lab_attachment_on)
                                                {{ Helpers::getdateFormat($data1->Kilo_Lab_attachment_on) }}
                                            @else
                                                Not Applicable
                                            @endif
                                        </div>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if ($data1->Technology_transfer_on)
                                                {{ Helpers::getdateFormat($data1->Technology_transfer_on) }}
                                            @else
                                                Not Applicable
                                            @endif
                                        </div>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if ($data1->Information_Technology_on)
                                                {{ Helpers::getdateFormat($data1->Information_Technology_on) }}
                                            @else
                                                Not Applicable
                                            @endif
                                        </div>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if ($data1->Project_management_on)
                                                {{ Helpers::getdateFormat($data1->Project_management_on) }}
                                            @else
                                                Not Applicable
                                            @endif
                                        </div>
                                    ...
                                    <tbody>
                                        @if($root_cause_data && is_array($root_cause_data))
                                            ...
                                            @foreach($root_cause_data as $rootCause_data)
                                                <tr>
                                                    <td class="w-20">{{ $serialNumber++ }}</td>
                                                    <td class="w-20">{{ $rootCause_data['rootCauseCategory'] ?? 'Not Applicable' }}</td>
                                                    <td class="w-20">{{ $rootCause_data['rootCauseSubCategory'] ?? 'Not Applicable' }}</td>
                                                    <td class="w-20">{{ $rootCause_data['ifOthers'] ?? 'Not Applicable' }}</td>
                                                    <td class="w-20">{{ $rootCause_data['probability'] ?? 'Not Applicable' }}</td>
                                                    <td class="w-20">{{ $rootCause_data['remarks'] ?? 'Not Applicable' }}</td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr>
