...
<body>
    ...
    <tr>
        <td>
            <strong style="color: #eba746">Audit Schedule By :</strong><br>
            {{ $data->audit_schedule_by ?? 'Not Applicable' }}
        </td>
        <td>
            <strong style="color: #eba746">Audit Schedule On :</strong><br>
    ...
    <tr>
        <td colspan="2">
            <strong style="color: #eba746">Audit Schedule Comment :</strong><br>
    ...
    <tr>
        <td>
            <strong style="color: #eba746">Cancelled By :</strong><br>
            {{ $data->cancelled_by ?? 'Not Applicable' }}
        </td>
        <td>
            <strong style="color: #eba746">Cancelled On :</strong><br>
    ...
    <tr>
        <td colspan="2">
            <strong style="color: #eba746">Cancelled Comment :</strong><br>
    ...
    <tr>
        <td>
            <strong style="color: #eba746">Complete Audit Preparation By :</strong><br>
            {{ $data->audit_preparation_completed_by ?? 'Not Applicable' }}
        </td>
        <td>
            <strong style="color: #eba746">Complete Audit Preparation On :</strong><br>
    ...
    <tr>
        <td colspan="2">
            <strong style="color: #eba746">Complete Audit Preparation Comment :</strong><br>
    ...
    <tr>
        <td>
            <strong style="color: #eba746">Reject By :</strong><br>
            {{ $data->rejected_by ?? 'Not Applicable' }}
        </td>
        <td>
            <strong style="color: #eba746">Reject On :</strong><br>
    ...
    <tr>
        <td colspan="2">
            <strong style="color: #eba746">Reject Comment :</strong><br>
    ...
    <tr>
        <td>
            <strong style="color: #eba746">Issue Report By :</strong><br>
            {{ $data->audit_mgr_more_info_reqd_by ?? 'Not Applicable' }}
        </td>
        <td>
            <strong style="color: #eba746">Issue Report On :</strong><br>
    ...
    <tr>
        <td colspan="2">
            <strong style="color: #eba746">Issue Report Comment :</strong><br>
    ...
    <tr>
        <td>
            <strong style="color: #eba746">CAPA Plan Proposed By :</strong><br>
            {{ $data->audit_observation_submitted_by ?? 'Not Applicable' }}
        </td>
        <td>
            <strong style="color: #eba746">CAPA Plan Proposed On :</strong><br>
    ...
    <tr>
        <td colspan="2">
            <strong style="color: #eba746">CAPA Plan Comment :</strong><br>
    ...
    <tr>
        <td>
            <strong style="color: #eba746">All CAPA Closed By :</strong><br>
            {{ $data->response_feedback_verified_by ?? 'Not Applicable' }}
        </td>
        <td>
            <strong style="color: #eba746">All CAPA Closed On :</strong><br>
    ...
    <tr>
        <td colspan="2">
            <strong style="color: #eba746">All CAPA Closed Comment :</strong><br>
            {{ $data->audit_mgr_more_info_reqd_on_comment ?? 'Not Applicable' }}
        </td>
    </tr>
</tbody>
