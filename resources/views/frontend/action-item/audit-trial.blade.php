            ...
            <body>
                <div style="display: flex; justify-content: flex-end;">
                    {{-- <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#auditReviewer"style="margin-right: 10px" >
                     ...
                     <a class="button_theme1 text-white" href="{{ url('rcms/actionItem',$document->id) }}" style="margin-right: 10px"> Back </a> 
                ...
                <header>
                    <table>
                        <tr>
                            {{-- <div class="logo">
                                <img src="https://www.medicefpharma.com/wp-content/uploads/2020/06/medicef-logo-new1.png" alt=""
                                    class="w-10">
                            </div> --}}
                        </tr>
                    </table>
                        ...
                        @foreach ($audit as $audits => $dataDemo)
                            ...
                            <td>
                                ...
                                <div style="margin-top: 5px;"> <strong>Performed On
                                        :</strong>{{ Helpers::getdateFormat($dataDemo->created_at ? $dataDemo->created_at : 'Not Applicable') }}
                                </div>
