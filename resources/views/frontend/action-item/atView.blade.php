        ...
        <div class="container-fluid">
            ...
            <div class="inner-block state-block">
                ...
                <div class="top-block mt-2">
                    <div><strong> Record Name:&nbsp;</strong>Action Item</div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">
                                            ...
                                            <input type="text" id="due_date_display" readonly
                                                placeholder="DD-MMM-YYYY" value="{{ Helpers::getDueDate(30, true) }}" />
                                            <input type="date" name="due_date"
                                                min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                value="{{ Helpers::getDueDate(30, false) }}" class="hide-input"
                                                readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select name="priority_data" placeholder="Select Reference Records"
                                            ...
                                            <option {{ $data->priority_data == 'High' ? 'selected' : '' }} value="High">
                                                High</option>
                                            <option {{ $data->priority_data == 'Medium' ? 'selected' : '' }}
                                                value="Medium">Medium</option>
                                            <option {{ $data->priority_data == 'Low' ? 'selected' : '' }} value="Low">
                                                Low</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <input name="short_description" id="docname" type="text"
                                            ...
                                            {{ $data->stage == 0 || $data->stage == 5 ? 'disabled' : '' }} type="text">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select {{ $data->stage == 0 || $data->stage == 5 ? 'disabled' : '' }} multiple
                            ...
                            <div class="sub-head">Activity Log</div>
                                ...
                                <div class="d-flex align-item-end justify-content-end">
                                        ...
                                        <button style="margin-bottom:20px;" class="button_theme1"> <a
                                                class="text-white"
                                                href="{{ url('rcms/action-item_activity', $data->id) }}"> Print </a>
                                        </button>
                                </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <strong>Work Completion By :</strong><br>
                                                            {{ $data->work_completion_by }}
                                                        </td>
                                                        <td>
                                                            <strong>Work Completion On :</strong><br>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <strong>Work Completion Comment :</strong><br>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <strong>QA/CQA Verification By :</strong><br>
                                                            {{ $data->qa_varification_by}}
                                                        </td>
                                                        <td>
                                                            <strong>QA/CQA Verification On :</strong><br>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <strong>QA/CQA Verification Comment :</strong><br>
    ...
    <div class="modal fade" id="signature-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('rcms/send-At-new', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
    ...
    <div class="modal fade" id="cancel-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('rcms/action-stage-cancel-new', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
