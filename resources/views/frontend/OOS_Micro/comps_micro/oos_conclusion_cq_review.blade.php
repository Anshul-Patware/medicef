                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="conclusion_comments_oosc" id="summernote-1">{{ $micro_data->conclusion_comments_oosc }}
                                    </textarea>
                        </div>
                    </div>
                     <!-- ---------------------------grid-1 -------------------------------- -->
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="justifi_for_averaging_results_oosc" id="summernote-1">{{ $micro_data->justifi_for_averaging_results_oosc }}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="justify_if_capa_not_required_oosc" id="summernote-1">{{ $micro_data->justify_if_capa_not_required_oosc }}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                           ...
                           <textarea class="tiny" name="justification_for_delay_oosc" id="summernote-1">{{ $micro_data->justification_for_delay_oosc }}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="conclusion_review_comments_ocr" id="summernote-1">{{ $micro_data->conclusion_review_comments_ocr }}
                             </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="action_taken_on_affec_batch_ocr" id="summernote-1">{{ $micro_data->action_taken_on_affec_batch_ocr }}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <select name="required_action_task_ocr">
                                ...
                                <option value="no" @if ($micro_data->required_action_task_ocr == 'no') selected @endif>No</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="justify_if_no_risk_assessment_ocr" id="summernote-1">{{ $micro_data->justify_if_no_risk_assessment_ocr }}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="cq_review_comments_OOS_CQ" id="summernote-1">{{ $micro_data->cq_review_comments_OOS_CQ }}
                            </textarea>
                </div>
            </div>
            <div class="col-lg-6">
