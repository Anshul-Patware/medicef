        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="qa_approver_comments_piii" id="summernote-1">{{ $micro_data->qa_approver_comments_piii }}
                            </textarea>
                </div>
            </div>
            <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="summary_of_exp_hyp_piiqcr" 
                            id="summernote-1">{{ $micro_data->summary_of_exp_hyp_piiqcr }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="summary_mfg_investigation_piiqcr" 
                            id="summernote-1">{{ $micro_data->summary_mfg_investigation_piiqcr }} </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="group-input">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="details_of_root_cause_piiqcr" id="summernote-1">{{ $micro_data->details_of_root_cause_piiqcr }}
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            <label for="Description Deviation">Impact Assessment.</label>
                                <textarea class="tiny" name="impact_assessment_piiqcr" id="summernote-1">{{ $micro_data->impact_assessment_piiqc }}
                                </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
