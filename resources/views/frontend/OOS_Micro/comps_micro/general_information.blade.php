...
<div id="CCForm1" class="inner-block cctabcontent">
        ...
        <div class="col-lg-6">
            <div class="group-input">
                ...
                <select disabled id="dynamicSelectType" name="type">
...
<div class="col-lg-6">
    <div class="group-input">
        <label for="RLS Record Number"><b>Record Number</b></label>
            ...
            value="{{ Helpers::getDivisionName($micro_data->division_id) }}/OOS Micro/{{ date('Y') }}/000{{ $micro_data->record}}">
    </div>
</div>
<div class="col-lg-6">
    <div class="group-input">
...
<div class="col-lg-6">
    <div class="group-input">
        ...
        <select name="severity_level_gi">
            ...
            <div class="col-lg-6 new-date-data-field">
                <div class="group-input input-date">
                    <label for="oos Occurred On"> Deviation Occurred On</label>
                    ...
                    <div class="calenderauditee">
                        ...
                        <input type="date" name="deviation_occured_on_gi" value="{{ $micro_data->deviation_occured_on_gi }}" class="hide-input" oninput="handleDateInput(this, 'deviation_occured_on_gi')" />
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
