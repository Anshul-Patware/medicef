        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="other_action_BI" id="summernote-1">{{ $micro_data->other_action_BI }}
                            </textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="other_parameter_result_BI" id="summernote-1">{{ $micro_data->other_parameter_result_BI }}
                    </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="trend_of_previous_batches_BI" id="summernote-1">{{ $micro_data->trend_of_previous_batches_BI }}
                    </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="stability_data_BI" id="summernote-1">{{ $micro_data->stability_data_BI }}
                    </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="process_validation_data_BI" id="summernote-1">{{ $micro_data->process_validation_data_BI }}
                        </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="method_validation_BI" id="summernote-1">{{ $micro_data->method_validation_BI }}
                    </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <textarea class="tiny" name="any_market_complaints_BI" id="summernote-1">{{ $micro_data->any_market_complaints_BI }}
                    </textarea>
                </div>
            </div>
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="statistical_evaluation_BI" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="risk_analysis_for_disposition_BI" id="summernote-1">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="conclusion_BI" id="summernote-1">
            ...
            <div class="col-lg-6">
                <div class="group-input">
                    ...
                    <select name="phase_III_inves_required_BI">
                        <option value="">Enter Your Selection Here</option>
                        <option value="yes" {{ (!empty($micro_data->phase_III_inves_required_BI) && in_array('yes', explode(',', $micro_data->phase_III_inves_required_BI[0]))) ? 'selected' : '' }}>Yes</option>
                        <option value="no" {{ (!empty($micro_data->phase_III_inves_required_BI) && in_array('no', explode(',', $micro_data->phase_III_inves_required_BI[0]))) ? 'selected' : '' }}>No</option>
                    </select>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-md-12 mb-4">
                <div class="group-input">
                    ...
                    <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                    <textarea class="tiny" name="justify_for_delay_BI" id="summernote-1">
