                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @endphp
                        ...
                        @elseif($data->stage == 4 && (in_array(5, $userRoleIds) || in_array(18, $userRoleIds) || in_array(Auth::user()->id, $valuesArray)))
                            ...
                            @endif
                        @elseif($data->stage == 5 && Helpers::check_roles($data->division_id, 'Change Control', 79) && !$userCompleted)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    ...
                                                    <div class="static">
                                                        <input type="text" disabled value="{{ $data->record_number }}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    <label for="changeControlNature">Change Control Nature <span class="text-danger">*</span></label>
                                                    <select name="changeControlNature" id="changeControlNature" required>
                                                        <option value="">--Select--</option>
                                                        <option value="P" @if($fields->changeControlNature == "P") selected @endif>Permanent</option>
                                                        <option value="T" @if($fields->changeControlNature == "T") selected @endif>Temporary</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    <label for="similarChangeControlRequired">Similar Change Control Required?</label>
                                                    <select name="similarChangeControlRequired" id="similarChangeControlRequired">
                                                        <option value="">--Select--</option>
                                                        <option value="Yes" @if($fields->similarChangeControlRequired == "Yes") selected @endif>Yes</option>
                                                        <option value="No" @if($fields->similarChangeControlRequired == "No") selected @endif>No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    <label for="Related Records">Similar Change Control</label>
                                                    <select multiple id="similarChangeControl" name="similarChangeControl[]" placeholder="Select Reference Records">
                                                        @if (!empty($pre))
                                                            @foreach ($pre as $previous)
                                                                @php
                                                                    $recordValue = $previous->record_number;
                                                                    $selected = in_array( $recordValue, explode(',', $fields->similarChangeControl),) ? 'selected' : '';
                                                                @endphp
                                            ...
                                            <input type="hidden" name="changeControlNatureInput" id="changeControlNatureInput" >

                                            <script>
                                                $(document).ready(function() {
                                                    $('#similarChangeControl').on('change', function() {
                                                        var selectedRecords = $(this).val();
                                                        var previousSimilarRecords = @json($allPreviousRecords->pluck('similarChangeControl')->flatten()->toArray());

                                                        var matchingRecordsCount = 0;

                                                        selectedRecords.forEach(function(record) {
                                                            var count = previousSimilarRecords.filter(function(existingRecord) {
                                                                return existingRecord === record;
                                                            }).length;
                                                            matchingRecordsCount += count;
                                                        });
                                                        
                                                        if (matchingRecordsCount >= 2) {
                                                            $('#changeControlNature').prop('disabled', true).val('P');
                                                            $('#changeControlNatureInput').prop('disabled', false).val('P');
                                                        } else {
                                                            $('#changeControlNature').prop('disabled', false).val('');
                                                        }
                                                    });
                                                });
                                            </script>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="group-input">
                                                    ...
                                                    <select name="Other1_review" id="Other1_review" @if($data->stage == 4) disabled @endif>
                                                        <option value="">-- Select --</option>
...
<script>
    ...
    <script>
        VirtualSelect.init({
            ele: '#related_records, #reviewer_person_value, #risk_assessment_related_record, #external_mutipleusers, #similarChangeControl'
        });
