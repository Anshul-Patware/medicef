...
@section('rcms_container')
                    ...
                    <div id="CCForm1" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="col-12">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="similarChangeControl">Similar Change Control</label>
                                        <select multiple id="similarChangeControl" name="similarChangeControl[]" placeholder="Select Similar Records" data-search="false" data-silent-initial-value-set="true">
                                            @foreach ($pre as $prix)
                                                <option value="{{ $prix->record_number }}">
                                                    {{ $prix->record_number }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <input type="hidden" name="changeControlCount" value="{{ $changeControlRecord }}" >
    ...
    <script>
        VirtualSelect.init({
            ele: '#related_records, #cft_reviewer, #risk_assessment_related_record, #similarChangeControl'
        });
