    ...
    <header>
        <table>
            <tr>
                ...
                <td class="w-30">
                    <div class="logo">
                        <img src="https://www.medicefpharma.com/wp-content/uploads/2020/06/medicef-logo-new1.png" alt="logo" class="w-100 ">
        ...
        <table>
            <tr>
                ...
                <td class="w-40">
                    {{ Helpers::getDivisionName($doc->division_id) }}/RCA/{{ date('Y') }}/{{ str_pad($doc->record, 4, '0', STR_PAD_LEFT) }}
                </td>
                <td class="w-30">
