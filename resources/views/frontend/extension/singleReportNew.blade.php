            ...
            <div class="block">
                ...
                <table>
                    <tr>
                        ...
                        <td class="w-80">
                            {{ $data->submit_on ? \Carbon\Carbon::parse($data->submit_on)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                        {{ $data->reject_on ? \Carbon\Carbon::parse($data->reject_on)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                        {{ $data->more_info_review_on ? \Carbon\Carbon::parse($data->more_info_review_on)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                        {{ $data->submit_on_review ? \Carbon\Carbon::parse($data->submit_on_review)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                        {{ $data->submit_on_inapproved ? \Carbon\Carbon::parse($data->submit_on_inapproved)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th class="w-20">More Information Required On</th>
                        <td class="w-80">
                        {{ $data->more_info_inapproved_on ? \Carbon\Carbon::parse($data->more_info_inapproved_on)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                        <th class="w-20">More Information Required Comment</th>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                        {{ $data->send_cqa_on ? \Carbon\Carbon::parse($data->send_cqa_on)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                        {{ $data->submit_on_approved ? \Carbon\Carbon::parse($data->submit_on_approved)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="w-80">
                        {{ $data->cqa_approval_on ? \Carbon\Carbon::parse($data->cqa_approval_on)->format('d-M-Y H:i:s') : 'N/A' }}
                        </td>
                    </tr>
                    <tr>
