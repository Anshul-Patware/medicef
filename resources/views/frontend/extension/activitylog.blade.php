                ...
                <div class="table-responsive">
                    ...
                    <tr>
                        <td>
                            ...
                            {{ $data->submit_by_review }}
                        </td>
                        <td>
                            <strong>Review On:</strong><br>
                            {{ $data->submit_on_review }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <strong>Review Comment:</strong><br>
                            {{ $data->submit_comment_review ?? 'Not Applicable' }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            {{ $data->submit_by_inapproved }}
                        </td>
                        <td>
                            <strong>Reject On:</strong><br>
                            {{ $data->submit_on_inapproved }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <strong>Reject Comment:</strong><br>
                            {{ $data->submit_commen_inapproved ?? 'Not Applicable' }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <strong>More Information Required By:</strong><br>
                            {{ $data->more_info_inapproved_by }}
                        </td>
                        <td>
                            <strong>More Information Required On:</strong><br>
                          {{$data->more_info_inapproved_on}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <strong>More Information Required Comment:</strong><br>
                            {{ $data->more_info_inapproved_comment ?? 'Not Applicable' }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            {{ $data->send_cqa_comment ?? 'Not Applicable' }}
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            {{ $data->submit_by_approved }}
                        </td>
                        <td>
                            <strong>Approved On:</strong><br>
                            {{ $data->submit_on_approved }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <strong>Approved Comment:</strong><br>
                            {{ $data->submit_comment_approved ?? 'Not Applicable' }}
                        </td>
                    </tr>
