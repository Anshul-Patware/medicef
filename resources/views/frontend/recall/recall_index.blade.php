...
<body>
    <div class="container-fluid main_container">
        ...
        <div>
            <form action="{{ route('recall_form_data', $unique1) }}" method="post">
                @csrf
                    ...
                    <div class="form-step active">
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-6">
                                ...
                                <input type="text"id="record_no" name="record_no" readonly
                                    value="Plant 1/CAPA/2025/00{{ $unique1 }}" class="input_style"
                                    style="color: gray !important" />
                            </div>
                            <div class="col-lg-6">
                                <label for="site_loca" class="field_style"> Site/Location Code </label>
                                <input type="text"id="site_loca" name="site_location" value="Plant 1"
