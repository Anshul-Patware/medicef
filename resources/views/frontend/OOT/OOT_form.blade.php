...
s                                            <option value="yes">Yes </option>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="oot_details" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments"> Product History</label>
                                        <textarea class="tiny" name="producct_history" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments"> Probable Cause</label>
                                        <textarea class="tiny" name="probble_cause" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments"> Investigation Details</label>
                                        <textarea class="tiny" name="investigation_details" id="investigation_details"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments"> Comments</label>
                                        <textarea class="tiny" name="comments" id="comments"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="corrective_action" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="preventive_action" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments">Comments</label>
                                        <textarea class="tiny" name="inv_comments" id="summernote-16"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="reason_for_stability" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="group-input">
                                    <label for="audit-agenda-grid">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments">Brief Description of OOT
                                            Details</label>
                                        <textarea class="tiny" name="description_of_oot_details" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments">Product History</label>
                                        <textarea class="tiny" name="sta_bat_product_history" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments">Probable Cause</label>
                                        <textarea class="tiny" name="sta_bat_probable_cause" id="summernote-16"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="elaborate_the_reson" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="cheklist_part_b_remarks" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="any_other_action" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments"> Re-analysis Result</label>
                                        <textarea class="tiny" name="re_analysis_result" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="group-input">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="part_b_comments" id="summernote-16"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="r_d_comments_part_b" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4">ADL Comments</label>
                                        <textarea class="tiny" name="a_d_l_comments" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4">Regulatory Comments</label>
                                        <textarea class="tiny" name="regulatory_comments" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4">Manufacturing Comments</label>
                                        <textarea class="tiny" name="manufacturing_comments" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4">Comments</label>
                                        <textarea class="tiny" name="technical_commitee_comments" id="summernote-16"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label class="mt-4" for="Audit Comments">Progress/Justification for
                                            Delay</label>
                                        <textarea class="tiny" name="progress_justification_delay" id="summernote-16"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="group-input ">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="remarks_by_qa_department" id="summernote-16"></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="closure_comments" id="summernote-16"></textarea>
                                    </div>
                                </div>
