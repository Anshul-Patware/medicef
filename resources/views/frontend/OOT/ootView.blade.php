...
s                                            <option value="Valid" @if ($data->valid_invalid == 'Valid') selected @endif>Valid </option>
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea name="if_others" value="{{ $data->if_others }}">{{ $data->if_others }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea name="repeat_nature" value="{{ $data->repeat_nature }}">{{ $data->repeat_nature }} </textarea>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-lg-6">
                                <div class="group-input">
                                    <label>OOT Occured On</label>
                                        <div class="calenderauditee">
                                            <input type="text" id="oot_occured_on"  value="{{ Helpers::getdateFormat($data['oot_occured_on'] ?? '') }}" placeholder="DD-MM-YYYY"  readonly/>
                            ...
                            <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    <label for="Deviation Occurred On">OOT Occured On</label>
                                    <div class="calenderauditee">
                                        <input type="text" id="oot_occured_on" value="{{ Helpers::getdateFormat($data['oot_occured_on'] ?? '') }}" placeholder="DD-MM-YYYY" />
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="oot_details" id="summernote-16" value="{{ $data->oot_details }}"> {{ $data->oot_details }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments"> Product History</label>
                                    <textarea class="tiny" name="producct_history" id="summernote-16" value="{{ $data->producct_history }}"> {{ $data->producct_history }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments"> Probable Cause</label>
                                    <textarea class="tiny" name="probble_cause" id="summernote-16" value="{{ $data->probble_cause }}">{{ $data->probble_cause }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments"> Investigation Details</label>
                                    <textarea class="tiny" name="investigation_details" id="summernote-16"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="comments" value="{{ $data->comments }}">{{ $data->comments }} </textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="corrective_action" value="{{ $data->corrective_action }}" id="summernote-16">{{ $data->corrective_action }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="preventive_action" value="{{ $data->preventive_action }}" id="summernote-16">{{ $data->preventive_action }} </textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments">Comments</label>
                                    <textarea class="tiny" name="inv_comments" id="summernote-16" value="{{ $data->inv_comments }}">{{ $data->inv_comments }} </textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="reason_for_stability" id="summernote-16"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments">Brief Description of OOT
                                        Details</label>
                                    <textarea class="tiny" name="description_of_oot_details" id="summernote-16"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments">Product History</label>
                                    <textarea class="tiny" name="sta_bat_product_history"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments">Probable Cause</label>
                                    <textarea class="tiny" name="sta_bat_probable_cause" id="summernote-16"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" value="{{ $checkList->elaborate_the_reson }}" name="elaborate_the_reson"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="cheklist_part_b_remarks" id="summernote-16">{{ $data->cheklist_part_b_remarks }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="any_other_action" value="{{ $data->any_other_action }}" id="summernote-16">{{ $data->any_other_action }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments"> Re-analysis Result</label>
                                    <textarea class="tiny" name="re_analysis_result" value="{{ $data->re_analysis_result }}"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="part_b_comments" value="{{ $data->part_b_comments }}" id="summernote-16">{{ $data->part_b_comments }}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="r_d_comments_part_b" value="{{ $data->r_d_comments_part_b }}"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="a_d_l_comments" value="{{ $data->a_d_l_comments }}" id="summernote-16">{{ $data->a_d_l_comments }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4">Regulatory Comments</label>
                                    <textarea class="tiny" name="regulatory_comments" value="{{ $data->regulatory_comments }}"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="manufacturing_comments" value="{{ $data->manufacturing_comments }}"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="technical_commitee_comments" value="{{ $data->technical_commitee_comments }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="progress_justification_delay"
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="remarks_by_qa_department" value="{{ $data->remarks_by_qa_department }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="group-input">
                                ...
                                <textarea class="tiny" name="closure_comments" value="{{ $data->closure_comments }}" id="summernote-16">{{ $data->closure_comments }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="ReviewComment" id="summernote-16"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny" name="Details" id="summernote-16"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="group-input">
                                    <label class="mt-4" for="Audit Comments"> Impact Assessment</label>
                                    <textarea class="tiny" name="ImpactAssessment" id="summernote-16"></textarea>
                                </div>
                            </div>
