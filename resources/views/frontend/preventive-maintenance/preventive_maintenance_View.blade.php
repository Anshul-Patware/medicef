    ...
    <div id="change-control-view">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-titles ml-10">Preventive Maintenance Workflow</h4>
                        </div>
        ...
        <div class="control-list">
            ...
            <div id="change-control-fields">
                ...
                <button class="cctablinks" onclick="openCity(event, 'CCForm1')">Preventive Maintenance Details</button>
