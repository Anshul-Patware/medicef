                                ...
                                <tbody id="searchTable">
                                    ...
                                    @foreach ($data as $key => $temp)
                                        <tr class="single-select">
                                            ...
                                            <form action="{{ route('question-bank.destroy', $temp->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                                <button type="submit" class=" btn btn btn-delete" ><i class="fa fa-trash"></i></button>
                                                </form>
                                                <a href="{{ route('question-bank.edit', $temp->id) }}" class="btn-manage">
