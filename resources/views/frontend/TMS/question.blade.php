    ...
    <div class="modal fade" id="add-question-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('question.store') }}" method="post" id="addQuestionForm" onsubmit="return validateForm()">
                    @csrf
                    <div class="modal-body">
                        <div class="group-input">
                            <label for="ques-type">Question Type</label>
                            ...
                            <p id="typecheck" style="color: red; display: none;">**Question Type is missing</p>
                        </div>
    
                        <div class="group-input" id="question-group">
                            <label for="ques">Question</label>
                            <input type="text" name="question" id="question" value="{{ old('question') }}">
                            <p id="questioncheck" style="color: red; display: none;">**Question is missing</p>
                        </div>
                        ...
                        <div class="group-input single_question-options" id="options-group">
                            ...
                            <div id="optionsdiv"></div>
                            <p id="optioncheck" style="color: red; display: none;">**Options are missing</p>
                        </div>
                        ...
                        <div class="group-input multi_question-options" id="multi_options-group">
                            ...
                            <div id="multi_optionsdiv"></div>
                            <p id="optioncheck2" style="color: red; display: none;">**Options are missing</p>
                        </div>
    ...
    <script>
        function validateForm() {
            ...
            if (questionType === 'Single Selection Questions') {
                options = document.querySelectorAll('#options-group input[name="options[]"]');
            } else if (questionType === 'Multi Selection Questions') {
                options = document.querySelectorAll('#multi_options-group input[name="options[]"]');
            }
    
            const optionCheck = document.getElementById('optioncheck') || document.getElementById('optioncheck2');
            const hasOptions = Array.from(options).some(option => option.value.trim() !== '');
            if (!hasOptions) {
