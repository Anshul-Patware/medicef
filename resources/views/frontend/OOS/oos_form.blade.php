                    ...
                    <div class="row">
                            ...
                            <div class="group-input">
                                ...
                                <div class="col-md-12 4">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny" name="Comments_plidata" id="summernote-1">
                                    </textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="justify_if_no_field_alert_pli" id="summernote-1">
                                    </textarea>
                            </div>
                        </div>
                        <!-- <div class="col-lg-6">
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="group-input">
                                <label for="Audit Schedule Start Date">Justify Analyst Int. </label>
                                    <textarea class="tiny" name="justify_if_no_analyst_int_pli" id="summernote-1">
                                    </textarea>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="summary_of_prelim_investiga_plic" id="summernote-1">
                                    </textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                               ...
                               <textarea class="tiny" name="oos_category_others_plic" id="summernote-1">
                                    </textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="root_cause_details_plic" id="summernote-1">
                                    </textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-4">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="delay_justification_for_pi_plic" id="summernote-1">
                                    </textarea>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <div class="group-input">
                                ...
                                <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                                <textarea class="tiny" name="review_comments_plir" id="summernote-1">
                                    </textarea>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="qa_approver_comments_piii" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-12">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="audit_comments_piii" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="hypo_exp_reference_piii" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="summary_of_exp_hyp_piiqcr" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="summary_mfg_investigation_piiqcr" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="details_of_root_cause_piiqcr" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="impact_assessment_piiqcr" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="review_comment_atp" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="additional_test_reference_atp" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="conclusion_comments_oosc" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="justifi_for_averaging_results_oosc" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="justify_if_capa_not_required_oosc" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="justification_for_delay_oosc" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="conclusion_review_comments_ocr" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="action_taken_on_affec_batch_ocr" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="justify_if_no_risk_assessment_ocr" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="cq_review_comments_ocqr" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="other_action_bd" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="other_parameters_results_bd" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="trend_of_previous_batches_bd" id="summernote-1">
                                    </textarea>
                        </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="stability_data_bd" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="process_validation_data_bd" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="method_validation_bd" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="any_market_complaints_bd" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="statistical_evaluation_bd" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="risk_analysis_disposition_bd" id="summernote-1">
                            </textarea>
                        </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="conclusion_bd" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="justify_for_delay_in_activity_bd" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div class="inner-block-content">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            <label for="Description Deviation">Other Action (Specify)</label>
                            <textarea class="tiny" name="other_action_specify_ro" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <textarea class="tiny" name="reopen_approval_comments_uaa" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                    <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="execution_comments_uae" id="summernote-1">
                                    </textarea>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="addendum_review_comments_uar" id="summernote-1">
                            </textarea>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="group-input">
                            ...
                            <!-- <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div> -->
                            <textarea class="tiny" name="verification_comments_uav" id="summernote-1">
                    </textarea>
                        </div>
                    </div>
