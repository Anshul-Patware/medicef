        ...
        <div class="container-fluid">
            <div class="inner-block">
                ...
                <div class="slogan">
                    ...
                    {{ Helpers::getDivisionName($equipment->division_id) }} / Equipment Lifecycle Management
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="change-control-view">
        <div class="container-fluid">
            ...
            <div class="inner-block state-block">
                ...
                <br>
                <div class="top-block">
                    <div><strong> Record Name :&nbsp;</strong>Equipment Lifecycle Management</div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="group-input">
                                                ...
                                                <select name="asset_type" id="asset_type" {{ $equipment->stage == 0 || $equipment->stage == 10 ? 'disabled' : '' }}>
                                                    <option value="">-- Select --</option>
                                                    <option value="Measuring" {{ $equipment->asset_type == 'Measuring' ? 'selected' : '' }}>Measuring</option>
                                                    <option value="Mixing" {{ $equipment->asset_type == 'Mixing' ? 'selected' : '' }}>Mixing</option>
                                                    <option value="Temperature Control" {{ $equipment->asset_type == 'Temperature Control' ? 'selected' : '' }}>Temperature Control</option>                                                   
                                                </select>
                                            </div>
                                        </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($trainingPlanData as $index => $item)                                                  
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number" {{ $data->stage == 4 ? '' : 'readonly' }} name="trainingPlanData[{{ $index }}][trainingAttempt]" value="{{ $item['trainingAttempt'] }}">
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <input type="number" name="trainingPlanData[{{ $index }}][total_minimum_time]" value="{{ $item['total_minimum_time'] }}" {{ $data->stage == 4 ? '' : 'readonly' }}>
                                                                </td>
                                                                <td>
                                                                    <input type="number" name="trainingPlanData[{{ $index }}][per_screen_run_time]" value="{{ $item['per_screen_run_time'] }}" {{ $data->stage == 4 ? '' : 'readonly' }}>
                                                                </td>
